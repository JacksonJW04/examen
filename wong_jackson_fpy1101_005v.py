...
def clasificar_sueldos():
    ...
    for trabajador, sueldo in zip(trabajadores, sueldos):
        if sueldo < 800000:
            print(f"Nombre empleado: {trabajador['nombre']}  {trabajador} Sueldo: ${sueldo}")
...
def reporte_sueldos():
    with open('reporte_sueldos.csv', 'w', newline='') as file:
        ...
        for trabajador, sueldo in zip(trabajadores, sueldos):
            ...
            print(f"Nombre empleado: {trabajador['nombre']}{trabajador} Sueldo Base: ${sueldo} Descuento Salud: ${descuento_salud:.2f} Descuento AFP: ${descuento_afp:.2f} Sueldo Líquido: ${sueldo_liquido:.2f}")
